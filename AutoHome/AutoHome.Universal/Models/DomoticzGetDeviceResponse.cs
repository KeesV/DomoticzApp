...
{
    [DataContract]
    public class DomoticzGetDeviceResponse : BaseDomoticzResponse
    {
        public int ActTime { get; set; }

        [DataMember(Name = "result")]
        public DomoticzGetDeviceResponseResult[] Result { get; set; }
    }

    public class DomoticzGetDeviceResponseResult
    {
